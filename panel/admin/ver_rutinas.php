				...
				<div class="row">
					...
					<div class="col-12">
						...
						<nav class="d-flex flex-row my-1">
							...
							<div class="d-inline-flex mx-2">
								<div data-toggle="tooltip" data-placement="top">
									<a class="d-inline-flex text-primary  font-weight-bold" href="ver_rutinas.php">Rutinas Predefinidas</a>
                  ...
                  ?>
									<tr>
										...
										<td>
											<a class="btn btn-secondary btn-sm mb-1" href='rutina_definida.php?idplanes=<?=$row->idplanes?>'>Mostrar</a>
											<a class="btn btn-secondary btn-sm mb-1" href='modificar_nombre_rutina.php?idplanes=<?=$row->idplanes?>'>Renombrar</a>
											<a class="btn btn-secondary btn-sm mb-1" href='php/eliminar_rutina_definida.php?idplanes=<?=$row->idplanes?>' onClick="return confirmar('ver_rutinas.php')">Eliminar</a>
										</td>
									</tr>
									<?php $i++; } ?>
								</tbody>
